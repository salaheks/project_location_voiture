            ...
            <div class="card">
                <form action="{{ route('voiture.update', $voiture->id) }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div>
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="immatriculation"
                                                    value="{{ old('immatriculation', $voiture->immatriculation) }}"
                                                    required>
                                            </div>
                                        </div>
                                        <div>
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="categorie">
                                                    @foreach (voiturecategories() as $key => $value)
                                                        <option value="{{ $key }}"
                                                            @if (old('categorie', $voiture->categorie) == $key) selected @endif>
                                                            {{ $value }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                                ...
                                                <select class="form-control" name="type_id">
                                                    @foreach ($types as $type)
                                                        <option value="{{ $type->id }}"
                                                            @if (old('type_id', $voiture->type_id) == $type->id) selected @endif>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="couleur">
                                                    @foreach (voiturecouleurs() as $key => $value)
                                                        <option value="{{ $key }}"
                                                            @if (old('couleur', $voiture->couleur) == $key) selected @endif>
                                                            {{ $value }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="row element">
                                            ...
                                            <div class="col-md-2 imageItem">
                                                <div class="payment-method-item">
                                                    <div class="flex-wrap payment-method-header d-flex">
                                                        <div class="thumb" style="position: relative;">
                                                            <div class="avatar-preview">
                                                                <div class="profilePicPreview"
                                                                    style="background-image: url('@if ($voiture->image) {{ asset('/storage/' . $voiture->image) }}@else{{ asset('assets/images/default.png') }} @endif')">
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" name="date_mise"
                                                        value="{{ old('date_mise', $voiture->date_mise) }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>@lang('Nombre de Porte')</label>
                                                    <input type="number" class="form-control" name="nombre_porte" value="{{ old('nombre_porte', $voiture->nombre_porte) }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>@lang('Nombre de Passager')</label>
                                                    <input type="number" class="form-control" name="nombre_passager" value="{{ old('nombre_passager', $voiture->nombre_passager) }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>@lang('Capacité de Bagage')</label>
                                                    <input type="text" class="form-control" name="capacite_bagage" value="{{ old('capacite_bagage', $voiture->capacite_bagage) }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="climatisation">
                                                        <option value="1" @if(old('climatisation', $voiture->climatisation) == 1) selected @endif>@lang('Oui')</option>
                                                        <option value="0" @if(old('climatisation', $voiture->climatisation) == 0) selected @endif>@lang('Non')</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="airbag">
                                                        <option value="1" @if(old('airbag', $voiture->airbag) == 1) selected @endif>@lang('Oui')</option>
                                                        <option value="0" @if(old('airbag', $voiture->airbag) == 0) selected @endif>@lang('Non')</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2-basic" name="mode_reglement">
                                                        @foreach (modereglement() as $key => $value)
                                                            <option value="{{ $key }}" @if(old('mode_reglement', $voiture->mode_reglement) == $key) selected @endif>{{ $value }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="prix_achat" value="{{ old('prix_achat', $voiture->prix_achat) }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="credit">
                                                        <option value="1" @if(old('credit', $voiture->credit) == 1) selected @endif>@lang('Oui')</option>
                                                        <option value="0" @if(old('credit', $voiture->credit) == 0) selected @endif>@lang('Non')</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6 credit-related">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="avance_credit" value="{{ old('avance_credit', $voiture->avance_credit) }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6 credit-related">
                                                <div class="form-group">
                                                    <label>@lang('Duree du Credit') (mois)</label>
                                                    <input type="number" class="form-control" name="duree_credit_mois" value="{{ old('duree_credit_mois', $voiture->duree_credit_mois) }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6 credit-related">
                                                <div class="form-group">
                                                    <label>@lang('Montant de Paiement') (mois)</label>
                                                    <input type="number" class="form-control" name="montant_paiement_par_mois" value="{{ old('montant_paiement_par_mois', $voiture->montant_paiement_par_mois) }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6 credit-related">
                                                <div class="form-group">
                                                    <label>@lang('Date Debut de Paiement')</label>
                                                    <input type="date" class="form-control" name="date_debut_paiement" value="{{ old('date_debut_paiement', $voiture->date_debut_paiement) }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="card-footer">
                        <button class="btn btn--primary w-100">@lang('Modifier')</button>
                    </div>
                </form>
            </div><!-- card end -->
        </div>
