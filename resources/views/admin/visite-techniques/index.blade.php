                            ...
                            <tbody>
                                @forelse($visiteTechniques as $visiteTechnique)
                                    <tr>
                                        ...
                                        <td data-label="@lang('Voiture')">
                                            {{ $visiteTechnique->voiture_id ? $visiteTechnique->voiture->immatriculation : ' ' }}
                                        </td>
                                        ...
                                        <td data-label="@lang('Action')">
                                            <a href="{{ route('visitetechnique.edit', $visiteTechnique->id) }}"
                                                class="icon-btn ml-1" data-original-title="@lang('Modifier')"
                                                data-toggle="tooltip">
                                ...
                                @empty
                                    <tr>
                                        <td class="text-muted text-center" colspan="100%">Pas de visite technique disponible
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
...
@push('breadcrumb-plugins')
    <a href="{{ route('visitetechnique.add') }}" class="btn btn-sm btn--primary box--shadow1 text-white text--small"><i
