                        ...
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                                @forelse($assurances as $assurance)
                                    <tr>
                                        <td>
                                            <span class="font-weight-bold">{{ $assurance->voiture ? $assurance->voiture->type->marque . ' ' . $assurance->voiture->type->model . ' ' . $assurance->voiture->immatriculation : '-' }}</span>
                                        </td>
                                        ...
                                        <td>
                                            <span
                                                class="font-weight-bold">{{ $assurance->assureur ? $assurance->assureur->nom : '-' }}</span>
                                        </td>
                                ...
                                @empty
                                    <tr>
                                        <td class="text-center text-muted" colspan="100%">aucun assurance disponible</td>
                                    </tr>
                                @endforelse
...
@push('breadcrumb-plugins')
    <a href="{{ route('assurances.create') }}" class="text-white btn btn-sm btn--primary box--shadow1 text--small">
