        ...
        <ul class="navbar__action-list">
            ...
            <li class="dropdown">
                <button type="button" class="primary--layer" data-toggle="dropdown" data-display="static"
                    ...
                    @if (\App\Config\constants\Consts::ADMIN_NOTIFICATIONS > 0)
                ...
                <div class="dropdown-menu dropdown-menu--md p-0 border-0 box--shadow1 dropdown-menu-right">
                    <div class="dropdown-menu__header">
                        ...
                        @if (\App\Config\constants\Consts::ADMIN_NOTIFICATIONS > 0)
                            <p>@lang('You have') {{ \App\Config\constants\Consts::ADMIN_NOTIFICATIONS }}
                                @lang('unread notification')</p>
                        @else
            ...
            <li class="dropdown">
                <button type="button" class="" data-toggle="dropdown" data-display="static" aria-haspopup="true"
                    ...
                    <span class="navbar-user">
                        <span class="navbar-user__thumb"><img src="{{ getImage('assets/admin/images/profile/') }}"
                                alt="image"></span>
